namespace Base {
  ...
  function calculateTotalWithWatchDiscount(cartTotal: number, cartItems: CartItem[]) : number {
    ...
    if(cartTotal > 100) {
        ...
        if(watchItem) {
            ...
            const discountAmount = originalWatchPrice * (watchDiscountPercentage / 100);
